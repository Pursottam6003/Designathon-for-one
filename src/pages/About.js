      ...
      <div className="about-component">
        <div className="container">
          ...
          <div className="about-technodaya">
            <p> Technodaya is the bimonthly newsletter of National Institute of Technology, Arunachal Pradesh. Every issue of this magazine contains the activities held within the last two months in the institute. </p></div>
          <div className="about-team">
            ...
            <div className="team-heading"> <h1> DEVELOPERS AND MAINTAINERS </h1></div>
            <div className="chutiyas">

              <div className="team-member-card">


                <div className="member-image"> <img alt="Chandrashekhar Tripathi" src={Chandrashekhar}></img></div>
