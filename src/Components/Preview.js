  ...
  updatePreview(updateType) {
    ...
    switch (category) {
      case 1:
        ...
        break;    
      case 2:
        outStr = `${this.ov('speakerName')}, ${this.ov('designation')}   delivered a ${this.ov('lectureType')} on "${this.ov('title')}" in the ${this.ov('eventName')} organised by ${this.ov('organizer')} on ${this.ov('date')}`;
        break;
      case 3:
        ...
        break;      
      case 4:
        // outStr = `${this.ov('pi[0])'} ,${this.ov('designation')} of ${this.ov('department')} with ${this.ov(copi[0])}  {designation} of {department} {insititute name} recieved a {project type/inside/outside} {title}. {funding agency} on {date} {photo}`
        outStr = ' '
        break;
      case 5:
