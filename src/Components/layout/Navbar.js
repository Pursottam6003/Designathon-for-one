      ...
      <div className='nav-content-wrapper container'>
        ...
        <div className='nav-items-wrapper'>
          <ul className='nav-items mobile'>
            ...
            <li><NavLink onClick={close} className='nav-item' to='/adminLog'> <div className='nav-item-txt'>Admin</div></NavLink></li>
          </ul>
          ...
          <ul className='nav-items desktop'>
            ...
            <li><NavLink className='nav-item' to="/adminLog" > <span className='nav-item-txt'>Admin</span></NavLink></li>
          </ul>
